SuggestedProducts = new Meteor.Collection('suggestedProducts');

SuggestedProductsSchema = new SimpleSchema({
    translation: {
        type: [Object],
        optional: true,
        blackbox: true,
...
SuggestedProducts.attachSchema( SuggestedProductsSchema );

SuggestedProducts.allow({
