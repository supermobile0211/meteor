...
Template.dashboard1.onRendered(function() {
    ...
    this.$("#flot-dashboard-chart").length && $.plot($("#flot-dashboard-chart"), [
            data1, data2
        ],
        {
            series: {
    ...
    this.$("#sparkline8").sparkline([5, 6, 7, 2, 0, 4, 2, 4, 5, 7, 2, 4, 12, 14, 4, 2, 14, 12, 7], {
        type: 'bar',
        barWidth: 8,
        height: '150px',
        barColor: '#1ab394',
    ...
    $.plot($("#flot-bar-chart-a"), [barData], barOptions);    
    $.plot($("#flot-bar-chart-b"), [barData], barOptions);    
    //$.plot($("#flot-bar-chart-c"), [barData], barOptions);
    // END DEMO Projects Creation charts
